...
class VisualElementDragControls {
    ...
    start(originEvent, { snapToCursor = false, distanceThreshold } = {}) {
        ...
        const resumeAnimation = () => motionDom.eachAxis((axis) => this.getAnimationState(axis) === "paused" &&
    ...
    pauseAnimation() {
        motionDom.eachAxis((axis) => this.getAxisMotionValue(axis).animation?.pause());
    }
    ...
    addListeners() {
        ...
        const stopPointerListener = addPointerEvent(element, "pointerdown", (event) => {
            ...
            const isClickingKeyboardAccessibleChild = target !== element &&
                motionDom.isElementKeyboardAccessible(target);
...
//# sourceMappingURL=feature-bundle-BGzaiKtK.js.map
